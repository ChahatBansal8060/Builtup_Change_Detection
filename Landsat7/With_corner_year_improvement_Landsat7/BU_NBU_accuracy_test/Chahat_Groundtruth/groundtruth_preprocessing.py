...
def main():
    ...
    for district in districts:
        for year in years:
            print("\nAnalyzing ",district,' in the year ',year,'\n')
            per_category_image_stats = {} #dictionary to store the statistics corresponding to each category of labels
            for category in categories:
                cropped_tiffiles_directory = input_groundtruth_directory+'/'+district+'/'+year+'/'+district+'_'+category
            ...
            input_tiffiles_directory = input_groundtruth_directory+'/'+district+'/'+year+'/'+district+'_'+min_category
            output_balanced_tiffiles_directory = output_groundtruth_directory+'/'+district+'/'+year+'/'+district+'_'+min_category
            ...
            for key, value in crop_size.items():
                input_tiffiles_directory = input_groundtruth_directory+'/'+district+'/'+year+'/'+district+'_'+key
                output_balanced_tiffiles_directory = output_groundtruth_directory+'/'+district+'/'+year+'/'+district+'_'+key
