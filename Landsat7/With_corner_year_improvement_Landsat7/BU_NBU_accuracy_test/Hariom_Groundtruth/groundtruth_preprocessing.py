...
def main():
    ...
    input_groundtruth_directory = 'Classification_Accuracy_Test'
    ...
    for district in districts:
        ...
        for category in categories:
            cropped_tiffiles_directory = input_groundtruth_directory+'/'+district+'/'+category
        ...
        input_tiffiles_directory = input_groundtruth_directory+'/'+district+'/'+min_category
        output_balanced_tiffiles_directory = output_groundtruth_directory+'/'+district+'/'+min_category
        ...
        for key, value in crop_size.items():
            input_tiffiles_directory = input_groundtruth_directory+'/'+district+'/'+key
            output_balanced_tiffiles_directory = output_groundtruth_directory+'/'+district+'/'+key
