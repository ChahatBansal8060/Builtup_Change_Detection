...
def main():
    ...
    for district in districts:
        png_images_directory = "BU_NBU_maps/"+district

        output_directory = png_images_directory+'/tifs'
        os.makedirs(output_directory, exist_ok=True)

        for year in years:
            png_image_filepath = png_images_directory +'/'+district+"_BU_NBU_"+year+".png"
            reference_tif_image_path = 'Reference_district_tiffiles/'+district+'.tif'
            
            out_image_path =  output_directory+'/'+district+"_BU_NBU_"+year+".tif"   
        ...
        print("Processed ",district," for year ",year)
